"""
CMUQ Floor 3 – Mobile Processing
Converts raw Firebase JSON export of a free-walk session →
data/cmuq/mobile/floor3.csv
...
Usage:
    python scripts/cmuq/process_mobile_f3.py
"""
...
# TODO: update raw filename when floor-3 mobile export is available
JSON_PATH = os.path.join(ROOT, "raw", "fingerprints_floor3_mobile.json")
OUT_CSV   = os.path.join(ROOT, "data", "cmuq", "mobile", "floor3.csv")
FLOOR     = 3
...
def main():
    ...
    # TODO: check export format when floor-3 mobile data arrives
    # Unwrap top-level wrapper key if present:
